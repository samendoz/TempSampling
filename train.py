...
for e in range(train_param['epoch']):
    ...
    if args.check_similarity and e % PROFILE_INTERVAL == 0:
        ...
        ########################################
        # if e < 10:
        #     # fn = 'results/simiarity_{}_profile_epoch_{}.png'.format(args.data,e)
        #     fn = 'results/simiarity_{}_profile_epoch_{}.pkl'.format(args.data,e)
        #     fn = 'profile/similarities/{}_batch_{}_epoch_{}.pkl'.format(args.data, train_param['batch_size'], e)
        #     # fn = None
        #     analysis_profile(plot_dir=fn)
        #     disable_profiling()
        #     reset_profile()
        # else:
        #     print("exiting due to batch similarity check mode...")
        #     sys.exit(0)
    ...
    if args.check_similarity_epoch:
        ...
        #     reset_n_record_profile()
        # elif e < 20:
        #     # fn = 'results/inter_epoch_simiarity_{}_profile_epoch_{}.png'.format(args.data,e)
        #     fn = 'results/inter_epoch_simiarity_{}_profile_epoch_{}.pkl'.format(args.data,e)
        #     # fn = None
        #     compare_profile(plot_dir=fn)
        #     reset_n_record_profile()
        # else:
        #     print("exiting due to epoch similarity check mode...")
        #     sys.exit(0)
