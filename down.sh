...
wget -P ./DATA/STACK_OVERFLOW https://snap.stanford.edu/data/sx-stackoverflow.txt.gz
wget -P ./DATA/WIKI_TALK https://snap.stanford.edu/data/wiki-talk-temporal.txt.gz
